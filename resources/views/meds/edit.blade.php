...
<div class="container-fluid py-5 px-2 h-screen">
    ...
    <div class="row justify-content-center mx-4">
        <div class="col-6 text-center my-4">
            ...
            <h1 class="mt-3">Edit Medication</h1>
        </div>
        <form method="POST" action="{{ route('meds.update', $med->id) }}">
            ...
            <div class="col-12 col-lg-6 mx-auto my-4">
                <div class="row">
                    <div class="col-12">
                        <input type="text" class="form-control custom-field" name="name" value="{{ $med->name }}"
                    ...
                    <div class="col-12 mt-3">
                        <textarea name="description" id="description" rows="5" placeholder="Description..."
                            class="form-control custom-field">{{ $med->description }}</textarea>
                    </div>
                </div>
            </div>
